...
| CONTAINER identifier WITH identifier AND identifier AND identifier
    { DeclContainer ($2, $4, $6, $8) }
| CONTAINER error /* parser12.mla parser13.mla parser15.mla */
    { error 2 "\"container <id> with <id> and <id> and <id>\" expected.\n\
	       The first identifier is the container type.\n\
               The next three are its map, fold, and fold2 functions." }
